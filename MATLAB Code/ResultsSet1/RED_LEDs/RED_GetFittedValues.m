...
spectrum_R1_AS_fit = fit(wavelength_AS, spectrum_R1_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum

% RED2
spectrum_R2_TL_fit = fit(wavelength_TL, spectrum_R2_TL_norm,'gauss5'); %fitting of ThorLabs normalized spectrum
spectrum_R2_AS_fit = fit(wavelength_AS, spectrum_R2_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum

% RED3
spectrum_R3_TL_fit = fit(wavelength_TL, spectrum_R3_TL_norm,'gauss5'); %fitting of ThorLabs normalized spectrum
spectrum_R3_AS_fit = fit(wavelength_AS, spectrum_R3_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum

% RED4
spectrum_R4_TL_fit = fit(wavelength_TL, spectrum_R4_TL_norm,'gauss6'); %fitting of ThorLabs normalized spectrum
spectrum_R4_AS_fit = fit(wavelength_AS, spectrum_R4_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum
...
spectrum_R6_AS_fit = fit(wavelength_AS, spectrum_R6_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum
