...
subplot(2,1,2);
plot(spectrum_R1_AS_fit,wavelengthC_AS, spectrum_R1_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R1_TL_peaks,locs_R1_1]=findpeaks(spectrum_R1_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R1_AS_peaks,locs_R1_2]=findpeaks(spectrum_R1_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_R2_AS_fit,wavelengthC_AS, spectrum_R2_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R2_TL_peaks,locs_R2_1]=findpeaks(spectrum_R2_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R2_AS_peaks,locs_R2_2]=findpeaks(spectrum_R2_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_R3_AS_fit,wavelengthC_AS, spectrum_R3_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R3_TL_peaks,locs_R3_1]=findpeaks(spectrum_R3_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R3_AS_peaks,locs_R3_2]=findpeaks(spectrum_R3_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_R4_AS_fit,wavelengthC_AS, spectrum_R4_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
subplot(2,1,2);
plot(spectrum_R5_AS_fit,wavelengthC_AS, spectrum_R5_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R5_TL_peaks,locs_R5_1]=findpeaks(spectrum_R5_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R5_AS_peaks,locs_R5_2]=findpeaks(spectrum_R5_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_R6_AS_fit,wavelengthC_AS, spectrum_R6_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R6_TL_peaks,locs_R6_1]=findpeaks(spectrum_R6_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R6_AS_peaks,locs_R6_2]=findpeaks(spectrum_R6_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_R8_AS_fit,wavelengthC_AS, spectrum_R8_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_R8_TL_peaks,locs_R8_1]=findpeaks(spectrum_R8_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_R8_AS_peaks,locs_R8_2]=findpeaks(spectrum_R8_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_RRG2T_AS_fit,wavelengthC_AS, spectrum_RRG2T_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_RRG2T_TL_peaks,locs_RRG2T_1]=findpeaks(spectrum_RRG2T_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_RRG2T_AS_peaks,locs_RRG2T_2]=findpeaks(spectrum_RRG2T_AS_yData,"NPeaks",2,"SortStr","descend");
...
subplot(2,1,2);
plot(spectrum_RRG3T_AS_fit,wavelengthC_AS, spectrum_RRG3T_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northeast');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
subplot(2,1,2);
plot(spectrum_RSTRIP_AS_fit,wavelengthC_AS, spectrum_RSTRIP_AS_norm);
axis([450 860 0 inf])
legend("Data","Fitted curve",'Location','northwest');
xlabel("Wavelength [nm]");
ylabel("Intensity (normalized)");
...
[spectrum_RSTRIP_TL_peaks,locs_RSTRIP_1]=findpeaks(spectrum_RSTRIP_TL_yData,"NPeaks",2,"SortStr","descend");
[spectrum_RSTRIP_AS_peaks,locs_RSTRIP_2]=findpeaks(spectrum_RSTRIP_AS_yData,"NPeaks",2,"SortStr","descend");
