...
spectrum_Y1_AS_fit = fit(wavelength_AS, spectrum_Y1_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum

% YELLOW2
spectrum_Y2_TL_fit = fit(wavelength_TL, spectrum_Y2_TL_norm,'gauss6'); %fitting of ThorLabs normalized spectrum
spectrum_Y2_AS_fit = fit(wavelength_AS, spectrum_Y2_AS_norm,'pchipinterp'); % fitting of AS7262 normalized spectrum
